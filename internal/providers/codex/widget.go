...
func dashboardWidget() core.DashboardWidget {
	cfg := providerbase.CodingToolDashboard(
		...
		providerbase.WithCompactRows(
			...
			core.DashboardCompactRow{Label: "Forecast", Keys: []string{"codex_rate_limit_burn_rate", "codex_rate_limit_runout_hours"}, MaxSegments: 2},
		...
		providerbase.WithMetricLabels(map[string]string{
			...
			"codex_rate_limit_burn_rate":       "Rate-Limit Burn Rate",
			"codex_rate_limit_runout_hours":    "Rate-Limit Runout",
		...
		providerbase.WithCompactLabels(map[string]string{
			...
			"codex_rate_limit_burn_rate":    "rate",
			"codex_rate_limit_runout_hours": "runout",
